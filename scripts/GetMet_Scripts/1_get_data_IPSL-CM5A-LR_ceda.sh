...
# Script Information
# --------------------------
# Purpose: Download the data for a CMIP5 ensemble: IPSL-CM5A-LR
...
out_base=/projectnb/dietzelab/paleon/met_ensemble/data/full_raw/IPSL-CM5A-LR/
...
#    
   ...
   # -----------
      ...
      path_p1000_mo=/badc/cmip5/data/cmip5/output1/IPSL/IPSL-CM5A-LR/past1000/mon/atmos/Amon/r1i1p1/latest
      var_p1000_mo=(rlds rsds)
...
#       # Define file path & variables of interest
#       path_hist_3h=/badc/cmip5/data/cmip5/output1/IPSL/IPSL-CM5A-LR/historical/3hr/atmos/3hr/r1i1p1/latest
