...
# Script Information
# --------------------------
# Purpose: Download the data for a CMIP5 ensemble: CCSM4
...
out_base=/projectnb/dietzelab/paleon/met_ensemble/data/full_raw/CCSM4/
...
# --------------------------
   ...
   # -----------
      ...
      path_p1000_day=/badc/cmip5/data/cmip5/output1/NCAR/CCSM4/past1000/day/atmos/day/r1i1p1/latest
      var_p1000_day=(tas tasmax tasmin pr  psl huss)
   ...
   # -----------
      ...
      path_p1000_mo=/badc/cmip5/data/cmip5/output1/NCAR/CCSM4/past1000/mon/atmos/Amon/r1i1p1/latest
      var_p1000_mo=(rlds rsds ua va)
...
# --------------------------
   ...
   # -----------
      ...
      Define file path & variables of interest
      path_hist_mon=/badc/cmip5/data/cmip5/output1/NCAR/CCSM4/historical/mon/atmos/Amon/r1i1p1/latest
      var_hist_mon=(rlds rsds huss ua va)
   ...
   # -----------
      ...
      Define file path & variables of interest
      path_hist_day=/badc/cmip5/data/cmip5/output1/NCAR/CCSM4/historical/day/atmos/day/r1i1p1/latest
      var_hist_day=(tas tasmin tasmax pr psl)
...
#       # Define file path & variables of interest
#       path_hist_3h=/badc/cmip5/data/cmip5/output1/NCAR/CCSM4/historical/3hr/atmos/3hr/r1i1p1/latest
