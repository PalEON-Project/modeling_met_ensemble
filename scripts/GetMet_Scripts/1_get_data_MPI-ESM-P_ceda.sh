...
# Script Information
# --------------------------
# Purpose: Download the data for a CMIP5 ensemble: MPI-ESM-P
# Creator: Christy Rollinson 8 July 2016
...
#       based on what was available at the following URL on 8 July 2016
...
out_base=/projectnb/dietzelab/paleon/met_ensemble/data/full_raw/MPI-ESM-P/
...
#       path_p1000_day=/badc/cmip5/data/cmip5/output1/MPI-M/MPI-ESM-P/past1000/day/atmos/day/r1i1p1/latest
#       var_p1000_day=(tas tasmax tasmin pr psl sfcWind)
# 
...
#       path_p1000_mo=/badc/cmip5/data/cmip5/output1/MPI-M/MPI-ESM-P/past1000/mon/atmos/Amon/r1i1p1/latest
#       var_p1000_mo=(hus rlds rsds)
# 
...
# --------------------------
   ...
   # -----------
      ...
      Define file path & variables of interest
      path_hist_mon=/badc/cmip5/data/cmip5/output1/MPI-M/MPI-ESM-P/historical/mon/atmos/Amon/r1i1p1/latest
      var_hist_mon=(rlds rsds hus)
...
#       Define file path & variables of interest
#       path_hist_day=/badc/cmip5/data/cmip5/output1/MPI-M/MPI-ESM-P/historical/day/atmos/day/r1i1p1/latest
#       var_hist_day=(tas tasmin tasmax pr psl sfcWind)
# 
#       Make a directory for the daily data so we can keep things separate
#       if [ ! -d ${outdir}day/ ]
#       then
...
#       # Define file path & variables of interest
#       path_hist_3h=/badc/cmip5/data/cmip5/output1/MPI-M/MPI-ESM-P/historical/3hr/atmos/3hr/r1i1p1/latest
