...
% x4   PDHI, defined as the x4(t)=0.897*x4(t-1)+Z/3,  where Z is Palmer's
%  Z inddex
%
%******************************** NOTES ***************************
%
...
%
% The PDHI circumvents the probability switching betweeen three alternative
% runnning versions of the index
...
x2=zeros(mz,1);
x3=zeros(mz,1);
x4=zeros(mz,1); % mod2080313 forPHDI
...
%*****************************************************************
% Initialize values for first month; assumes x1,x2, x3, x4==0 in previous month
