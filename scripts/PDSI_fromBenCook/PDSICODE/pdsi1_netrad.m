function datout=pdsi1_netrad(datmon,datother,snowinf,textin,kopt,penopts,datpen,PE)
% pdsi1:  Palmer Drought Severity Index
% CALL: datout=pdsi1(datmon,datother,snowinf,textin,kopt,penopts,datpen,PE);
%
%*******************  IN **************************
%
...
%     estimated potential evapotranspiration.  If the difference is less
%     than 
...
%BIC-correction if years are not fully continuous
yr1=yrta;
...
Dbar(find(Dbar==0))=0.0000001;  % BIC Correction
...
XH = (reshape(x4,12,nyrsfull))'; %---modified 20080312

datout={[yr1 Z],[yr1 X],[yr1 XM],[yr1 Z], W,[yr1 RO], S1,[yr1 P],[yr1,T],[yr1 XH]}; %---modified 20080312
